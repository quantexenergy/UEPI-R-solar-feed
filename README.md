...
```
2026-03-24 00:45 UTC | Status: QUIET | P(M1.0+ within 24h): 23.2%
```
...
| Metric | Value |
|--------|-------|
| M-class coverage | **66.7%** (8/12 flares detected) |
| Median lead time | **8h 20m** |
| Total alerts | 57 |
| Verified hits | 8 |
| False alerts | 49 |
| C-class associated | 41/49 false alerts (84% detecting real activity) |
