...
```
2026-03-29 00:00 UTC | Status: QUIET | P(M1.0+ within 24h): 32.6%
```
...
| Metric | Value |
|--------|-------|
| M-class coverage | **61.5%** (8/13 flares detected) |
| Median lead time | **8h 20m** |
| Total alerts | 61 |
| Verified hits | 8 |
| False alerts | 53 |
| C-class associated | 45/53 false alerts (85% detecting real activity) |
| Pending | 1 |
