...
```
2026-04-04 06:00 UTC | Status: QUIET | P(M1.0+ within 24h): 29.6%
```
...
| Metric | Value |
|--------|-------|
| M-class coverage | **61.1%** (11/18 flares detected) |
...
```diff
! MISS Flare: M7.5 at 2026-04-04 01:07 UTC  |  No alert issued
