...
|--------|-------|
| Verified hits | **22** |
| M-class coverage | **61.8%** (21/34 flares) |
| M-class hit rate | **25.0%** (21/84) |
| X-class hit rate | **1.2%** (1/84) |
| False alerts | 62/84 |
| C-class associated | 52/62 false alerts |
| Median lead time | **6h 20m** |
| Pending verification | 4 |
| Last updated | 2026-04-26T09:00:26Z |
...
|--------|:--------:|:------------------:|
| M-class coverage | 61.8% (21/34) | **59.1%** (13/22) |
| X-class hits | 1 | **1** |
| Precision | 26.2% | **50.0%** |
| False alerts | 62 | **14** |
| Median lead time | 6h 20m | **5h 42m** |
| Alerts | 84 | 28 |

## Event Log

```diff
! MISS Flare: M1.3 at 2026-04-26 00:08 UTC  |  No alert issued
